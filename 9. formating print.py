...
print('here is a %s number and an %d integer' %(3.14159, 3.14159))

# %d TRUNCATES into integers:
print('Floating point numbers: %1.3f' %(13.9876))

# %f for floating - indicates (total digits to print).(digita after decimal):
